---
name: magic-ui
description: Use this skill when users want to add, customize, or troubleshoot Magic UI components in React/Next.js projects. It covers component selection, shadcn registry installation, integration patterns, and practical quality checks for accessibility and maintainability.
type: workflow
---
