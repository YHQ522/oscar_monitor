...
_log = logging.getLogger('oscar_monitor.collector')
...
OS_CHECKS_LINUX = None  # populated by collector_os import below
OS_CHECKS_WIN = None
OS_CHECKS = {}  # default, overwritten by collector_os
OS_CHECK_LABELS = {}

# Import OS-layer (circular-safe: collector_os imports back from collector)
from collector_os import (OS_CHECKS_LINUX as _OSC_LINUX,
                          OS_CHECKS_WIN as _OSC_WIN,
                          OS_CHECK_LABELS as _OSC_LABELS,
                          _os_checks, collect_os_info)
OS_CHECKS_LINUX = _OSC_LINUX
OS_CHECKS_WIN = _OSC_WIN
OS_CHECKS = OS_CHECKS_LINUX
OS_CHECK_LABELS = _OSC_LABELS

del _OSC_LINUX, _OSC_WIN, _OSC_LABELS
